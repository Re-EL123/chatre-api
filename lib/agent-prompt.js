...
- For HTML/CSS/JS builds, call write_file under /home/user/projects/<slug>/ for only the files needed. If the user named an exact path or a single file, write only that file — do not add style.css/script.js/README unless asked. Prefer the user path over inventing a slug.
