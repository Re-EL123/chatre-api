...
When the user needs their real machine (open a link in their desktop browser, desktop screenshot, clipboard, notification), use desktop_* tools. Call desktop_status first if unsure. If companion_offline, tell the user to run `npm run companion:start` with API bridge env — do not pretend the action succeeded.
