...
When the user needs their real machine (open a link in their desktop browser, desktop screenshot, clipboard, notification), use desktop_* tools. Call desktop_status first if unsure. These require the local companion bridged to the API. Cloud browser tools (navigate/computer/…) are separate and do not control the user's desktop.
