...
Prefer cwd/workdir over \`cd &&\`. Do NOT use shell for file ops — use read_file, write_file, find_files, search_code, patch_file. Oversized output spills to /home/user/tmp/; read that path instead of head/tail. Only git commit/push when the user asked.
