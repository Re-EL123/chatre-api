  ...
  if (kind === 'build' || kind === 'debug' || kind === 'git') {
    if (!fileOk) {
      return (
        ...
        '/home/user/projects/<slug>/ (start with index.html; add only the files you actually create). ' +
        'Shell, Python open(), and chat dumps do NOT create files. Do not invent style.css/script.js. Do not narrate this message.'
      );
    }
