...
const PLAYBOOKS = {
  ...
  research:
    'search_web → fetch/read key pages → synthesize with citations. Optionally save /home/user/documents/research-notes.md.',
  browser:
    'tabs_create → navigate → read_page/find → act with refs. Re-read after navigation.',
  document:
    'view_tree("/home/user") once if needed, then create_pdf or create_document into /home/user/documents. One successful file tool = done. No browse/code theatre.',
  build:
    'view_tree/list_directory on /home/user/projects → todos → write under /home/user/projects/<slug> → verify_project or execute_command.',
  debug:
    'Reproduce → read failing files in the workspace → patch_file → re-run. Stay in the project tree.',
