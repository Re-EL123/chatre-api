...
const TOOL_DEFS = [
  {
    ...
    function: {
      name: 'todo',
      description:
        'Manage the OpenCode-style todo list. Actions: set, add, done, list.',
      parameters: {
        type: 'object',
        properties: {
          action: {
  ...
  },
  {
    ...
    function: {
      ...
      description: 'Open a URL in a real browser and return page text, links, inputs, and a screenshot note.',
      parameters: {
        type: 'object',
        properties: {
          url: { type: 'string' },
  ...
  },
  {
    ...
    function: {
      name: 'browser_click',
      description: 'Click a CSS selector on the current page (call browser_navigate first in the same session flow).',
      parameters: {
        type: 'object',
        properties: {
  ...
  },
  {
    ...
    function: {
      ...
      description: 'Capture a screenshot of the current (or given) page.',
      parameters: {
        type: 'object',
        properties: {
          url: { type: 'string' },
  ...
  },
  {
    ...
    function: {
      name: 'browser_read',
      description: 'Read page title, visible text, and HTML snippet.',
      parameters: {
        type: 'object',
  ...
  },
  {
    ...
    function: {
      ...
      description: 'Run JavaScript in the page and return the result plus a snapshot.',
      parameters: {
        type: 'object',
        properties: {
          script: { type: 'string' },
  ...
  },
  {
    ...
    function: {
      name: 'browser_wait',
      description: 'Wait for a selector or a short delay, then snapshot.',
      parameters: {
        type: 'object',
        properties: {
          selector: { type: 'string' },
  ...
  },
  {
    ...
    function: {
      name: 'browser_scroll',
      description: 'Scroll the page by pixels (default 800 down).',
      parameters: {
        type: 'object',
        properties: {
          y: { type: 'number' },
  ...
  },
  {
    ...
    function: {
      name: 'http_request',
      description: 'HTTP GET/POST/etc to a public URL (APIs, downloads). Prefer this over the browser for raw HTTP.',
      parameters: {
        type: 'object',
        properties: {
          url: { type: 'string' },
