...
const TOOL_DEFS = [
  ...
  },
  {
    ...
    function: {
      name: 'delegate_task',
      description:
        'Spawn a short nested agent for a focused subgoal. Keep goals small. Use agent=explore for read-only search.',
      parameters: {
        type: 'object',
        properties: {
          goal: { type: 'string' },
          ...
          agent: {
            type: 'string',
            description: 'Subagent name: explore|general|build or a custom agent id',
          },
          thoroughness: {
            type: 'string',
