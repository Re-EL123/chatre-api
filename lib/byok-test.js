...
const PROVIDERS = ['openrouter', 'aihubmix', 'zai', 'groq', 'deepseek', 'mistral', 'xai', 'anthropic', 'openai', 'google'];
  ...
  try {
    ...
    if (!String(text).trim()) {
      const hints = {
        ...
        groq:
          'Key accepted but the model returned empty text. Retry Test, or try llama-3.3-70b-versatile.',
        deepseek:
