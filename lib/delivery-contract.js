...
function buildDoneProof(ctx, opts) {
  ...
  return {
    ...
    previewOk: forceFail ? false : lightAnswer ? true : !!(ctx && ctx.previewOk),
    previewUrl,
    localhost: previewUrl,
    testsOk: forceFail ? false : lightAnswer ? true : !!(ctx && ctx.testsOk),
    ...
    ciOk: forceFail ? false : lightAnswer ? true : !!(ctx && ctx.ciOk),
