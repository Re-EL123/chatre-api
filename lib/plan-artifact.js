...
function handoffPrompt(plan, blackboardText) {
  ...
  return (
    ...
    '\n\n## Strategy\n' +
    '1. Optionally delegate_task(agent=explore) for a map of relevant paths.\n' +
    '2. Implement with write_file/patch_file (or delegate_task agent=general for isolated slices).\n' +
    '3. Parallelize only independent explore/read goals via goals[] on delegate_task.\n' +
    '4. Hand verify to preview: call preview_project (or delegate_task agent=verify).\n' +
    '5. Fix preview errors; do not claim done until preview ok.\n\n' +
