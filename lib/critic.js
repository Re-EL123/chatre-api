...
const CRITIC_PROMPT = `You are Chatre's critic (plan adherence role). Decide if the team finished the user's request against the approved plan.

Given the user request, plan artifact, success criteria, blackboard notes, and executor answer, output ONLY JSON:
{
  "pass": true|false,
  "score": 0-100,
