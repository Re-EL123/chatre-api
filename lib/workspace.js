...
async function bumpRevision(workspaceId, opts) {
  ...
  if (o.lastPr !== undefined) patch.lastPr = o.lastPr;
  if (o.lastCi !== undefined) patch.lastCi = o.lastCi;
  if (o.ciOk !== undefined) patch.ciOk = o.ciOk;
  if (o.roots !== undefined) patch.roots = o.roots;
  if (o.contextIndexMeta !== undefined) patch.contextIndexMeta = o.contextIndexMeta;
  if (getBackend() === 'firestore') {
...
async function saveSnapshot(workspaceId, opts) {
  ...
  if (lastPr !== undefined) patch.lastPr = lastPr;
  if (lastCi !== undefined) patch.lastCi = lastCi;
  if (ciOk !== undefined) patch.ciOk = ciOk;
  if (roots !== undefined) patch.roots = roots;
