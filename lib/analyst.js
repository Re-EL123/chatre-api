...
- If the user shares a github.com (or similar) URL / asks to clone a repo, set task_type to "build" and tools_priority including git_clone, search_code, run_tests.
