...
const LAYERS = [
  ...
  },
  {
    id: 2,
    name: 'Context Engine',
    role: 'Structural chunking, merkle index, hybrid BM25+rg, Priompt packing',
    surfaces: ['chatre-api/lib/context-rag.js', 'chatre-api/lib/context-cache.js'],
    gateway: '/api/workspace?action=index|context',
  },
  {
    id: 3,
    name: 'Cognitive & Execution',
    role: 'Plan → understand → execute → critic → verify; model routing; worktrees',
    surfaces: [
