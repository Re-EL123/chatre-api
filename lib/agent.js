 ...
 */
function applyComposerModeTaskOverrides(briefing, composerMode) {
  ...
  if (isResume && existingRun && Array.isArray(existingRun.messages)) {
    ...
    let isLightEarly =
      ...
      (briefing.task_type === 'question' &&
        (!briefing.todos || !briefing.todos.length) &&
        (!briefing.tools_priority || !briefing.tools_priority.length));
    if (composerIsAgenticEarly || incrementalOnProjectEarly) {
      isLightEarly = false;
      if (
        briefing.task_type === 'chat' ||
        briefing.task_type === 'question' ||
    ...
    applyComposerModeTaskOverrides(briefing, composerMode);
    ...
    let isLight =
      ...
      (briefing.task_type === 'question' &&
        (!briefing.todos || !briefing.todos.length) &&
        (!briefing.tools_priority || !briefing.tools_priority.length));
    if (composerIsAgentic || incrementalOnProject) {
      isLight = false;
      if (
        briefing.task_type === 'chat' ||
        briefing.task_type === 'question' ||
